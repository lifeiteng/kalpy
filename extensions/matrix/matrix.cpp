...
void pybind_kaldi_matrix(py::module &m) {
  py::class_<MatrixBase<float>,
      ...
      .def("Row",
           (const SubVector<float> (MatrixBase<float>::*)(MatrixIndexT) const) &
               MatrixBase<float>::Row,
           "Return specific row of matrix.", py::arg("i"))
      .def("Row",
           (SubVector<float>(MatrixBase<float>::*)(MatrixIndexT)) &
               MatrixBase<float>::Row,
           "Return specific row of matrix.", py::arg("i"))
      .def("Range", &MatrixBase<float>::Range, "Return a sub-part of matrix.",
           py::arg("row_offset"), py::arg("num_rows"), py::arg("col_offset"),
           py::arg("num_cols"))
      .def("RowRange", &MatrixBase<float>::RowRange, py::arg("row_offset"),
           py::arg("num_rows"))
      .def("ColRange", &MatrixBase<float>::ColRange, py::arg("col_offset"),
           py::arg("num_cols"))
      ...
      .def("SetUnit", &MatrixBase<float>::SetUnit,
           "Sets to zero, except ones along diagonal [for non-square matrices "
           "too]")
      .def("SetZero", &MatrixBase<float>::SetZero, "Sets matrix to zero.")
      .def("SetRandn", &MatrixBase<float>::SetRandn,
           "Sets to random values of a normal distribution")
      .def("SetRandUniform", &MatrixBase<float>::SetRandUniform,
  ...
  py::class_<Matrix<float>, MatrixBase<float>>(m, "FloatMatrix",
      ...
      .def("Resize", &Matrix<float>::Resize,
           ...
           "  -if kCopyData, the new data will be the same as the old data in "
           "any "
           "     shared positions, and zero elsewhere. "
           "This function takes time proportional to the number of data "
           "elements.",
           py::arg("r"), py::arg("c"), py::arg("resize_type") = kSetZero,
           py::arg("stride_type") = kDefaultStride)
      .def("from_numpy",
           [](Matrix<float> &M, py::array_t<float> array) {
             py::buffer_info info = array.request();
             int32 ndim = array.ndim();
             KALDI_ASSERT(ndim == 2);
             auto r = array.unchecked<2>();  // x must have ndim = 2; can be
                                             // non-writeable
  ...
  py::class_<SubMatrix<float>, MatrixBase<float>>(m, "FloatSubMatrix")
      .def(py::init<const MatrixBase<float> &, const MatrixIndexT,
                    const MatrixIndexT, const MatrixIndexT,
                    const MatrixIndexT>(),
           py::arg("T"), py::arg("ro"), py::arg("r"), py::arg("co"),
           py::arg("c"))
      .def(py::init<float *, MatrixIndexT, MatrixIndexT, MatrixIndexT>(),
           py::arg("data"), py::arg("num_rows"), py::arg("num_cols"),
           py::arg("stride"))
  ...
  py::class_<MatrixBase<double>,
      ...
      "care of allocation and resizing.")
      .def("Row",
           (const SubVector<double> (MatrixBase<double>::*)(MatrixIndexT)
                const) &
               MatrixBase<double>::Row,
           "Return specific row of matrix.", py::arg("i"))
      .def("Row",
           (SubVector<double>(MatrixBase<double>::*)(MatrixIndexT)) &
               MatrixBase<double>::Row,
           "Return specific row of matrix.", py::arg("i"))
      ...
      .def("LogDet", &MatrixBase<double>::LogDet, "Returns logdet of matrix.",
           py::arg("det_sign") = NULL)
      .def("RowRange", &MatrixBase<double>::RowRange, py::arg("row_offset"),
           py::arg("num_rows"))
      .def("ColRange", &MatrixBase<double>::ColRange, py::arg("col_offset"),
           py::arg("num_cols"))
      .def("NumRows", &MatrixBase<double>::NumRows, "Return number of rows")
      .def("SetUnit", &MatrixBase<double>::SetUnit,
           "Sets to zero, except ones along diagonal [for non-square matrices "
           "too]")
      .def("SetZero", &MatrixBase<double>::SetZero, "Sets matrix to zero.")
      .def("SetRandn", &MatrixBase<double>::SetRandn,
           "Sets to random values of a normal distribution")
      .def("SetRandUniform", &MatrixBase<double>::SetRandUniform,
           "Sets to numbers uniformly distributed on (0, 1)")
  ...
  py::class_<Matrix<double>, MatrixBase<double>>(m, "DoubleMatrix",
      ...
      .def("Resize", &Matrix<double>::Resize,
           ...
           py::arg("stride_type") = kDefaultStride)
      .def("from_numpy",
           [](Matrix<double> &M, py::array_t<double> array) {
             py::buffer_info info = array.request();
             int32 ndim = array.ndim();
             KALDI_ASSERT(ndim == 2);
             auto r = array.unchecked<2>();  // x must have ndim = 2; can be
...
void pybind_kaldi_vector(py::module &m) {
  py::class_<VectorBase<float>,
      ...
      .def("SetZero", &VectorBase<float>::SetZero, "Set vector to all zeros.")
      .def("IsZero", &VectorBase<float>::IsZero,
           "Returns true if matrix is all zeros.", py::arg("cutoff") = 1.0e-06)
      .def("Set", &VectorBase<float>::Set,
           "Set all members of a vector to a specified value.", py::arg("f"))
      ...
      .def("Ceiling", &VectorBase<float>::Ceiling,
           ...
           py::arg("v"), py::arg("ceil_val"), py::arg("ceiled_count") = nullptr)
      .def("Pow", &VectorBase<float>::Pow, py::arg("v"), py::arg("power"))
      ...
      .def("ApplyFloor",
           py::overload_cast<float, MatrixIndexT *>(
               &VectorBase<float>::ApplyFloor),
           "Applies floor to all elements. Returns number of elements "
           "floored in floored_count if it is non-null.",
           py::arg("floor_val"), py::arg("floored_count") = nullptr)
      .def("ApplyCeiling", &VectorBase<float>::ApplyCeiling,
           "Applies ceiling to all elements. Returns number of elements "
           "changed in ceiled_count if it is non-null.",
           py::arg("ceil_val"), py::arg("ceiled_count") = nullptr)
      .def("ApplyFloor",
           py::overload_cast<const VectorBase<float> &>(
               &VectorBase<float>::ApplyFloor),
           "Applies floor to all elements. Returns number of elements floored.",
           py::arg("floor_vec"))
      .def(
          "ApplySoftMax", &VectorBase<float>::ApplySoftMax,
          "Apply soft-max to vector and return normalizer (log sum of "
          "exponentials). "
          "This is the same as: \\f$ x(i) = exp(x(i)) / \\sum_i exp(x(i)) \\f$")
      .def(
          "ApplyLogSoftMax", &VectorBase<float>::ApplyLogSoftMax,
          "Applies log soft-max to vector and returns normalizer (log sum of "
          "exponentials). "
          "This is the same as: \\f$ x(i) = x(i) - log(\\sum_i exp(x(i))) \\f$")
      .def("Tanh", &VectorBase<float>::Tanh,
           "Sets each element of *this to the tanh of the corresponding "
           "element of \"src\".",
           py::arg("src"))
      .def("Sigmoid", &VectorBase<float>::Sigmoid,
           "Sets each element of *this to the sigmoid function of the "
           "corresponding "
           "element of \"src\".",
           py::arg("src"))
      .def("ApplyPow", &VectorBase<float>::ApplyPow,
           "Take all  elements of vector to a power.", py::arg("power"))
      .def("ApplyPowAbs", &VectorBase<float>::ApplyPowAbs,
           "Take the absolute value of all elements of a vector to a power. "
           "Include the sign of the input element if include_sign == true. "
           "If power is negative and the input value is zero, the output is "
           "set zero.",
           py::arg("power"), py::arg("include_sign") = false)
      .def("Norm", &VectorBase<float>::Norm,
           "Compute the p-th norm of the vector.", py::arg("p"),
           py::call_guard<py::gil_scoped_release>())
      .def("ApproxEqual", &VectorBase<float>::ApproxEqual,
           "Returns true if ((*this)-other).Norm(2.0) <= tol * "
           "(*this).Norm(2.0).",
           py::arg("other"), py::arg("tol") = 0.01)
      .def("AddVec",
           py::overload_cast<const float, const VectorBase<float> &>(
               &VectorBase<float>::AddVec<float>),
           "Add vector : *this = *this + alpha * rv (with casting between "
           "floats and doubles)",
           py::arg("alpha"), py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def(
          "CopyFromVec",
          [](VectorBase<float> &v, const VectorBase<float> &other) {
            v.CopyFromVec(other);
          },
      ...
      /*.def("AddVec2",
        py::overload_cast<const float, const VectorBase<float>
        &>(&VectorBase<float>::AddVec2<float>), "Add vector : *this = *this +
        alpha * rv^2  [element-wise squaring].", py::arg("alpha"),
        py::arg("v"))*/
      .def("AddMatVec", &VectorBase<float>::AddMatVec,
           "Add matrix times vector : this <-- beta*this + alpha*M*v. Calls "
           "BLAS GEMV.",
           py::arg("alpha"), py::arg("M"), py::arg("trans"), py::arg("v"),
           py::arg("beta"), py::call_guard<py::gil_scoped_release>())
      .def("AddMatSvec", &VectorBase<float>::AddMatSvec,
      ...
      .def("AddTpVec",
        ...
        py::arg("v"),
        py::arg("beta"))*/
      .def("ReplaceValue", &VectorBase<float>::ReplaceValue,
           "Set each element to y = (x == orig ? changed : x).",
           py::arg("orig"), py::arg("changed"),
           py::call_guard<py::gil_scoped_release>())
      .def("MulElements",
           (void(VectorBase<float>::*)(const VectorBase<float> &)) &
               VectorBase<float>::MulElements,
           "Multiply element-by-element by another vector.", py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def("DivElements",
           (void(VectorBase<float>::*)(const VectorBase<float> &)) &
               VectorBase<float>::DivElements,
           "Divide element-by-element by another vector.", py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def("Add", &VectorBase<float>::Add,
           "Add a constant to each element of a vector.", py::arg("c"),
           py::call_guard<py::gil_scoped_release>())
      .def("AddVecVec", &VectorBase<float>::AddVecVec,
           "Add element-by-element product of vectors: this <-- alpha * v .* r "
           "+ beta*this .",
           py::arg("alpha"), py::arg("v"), py::arg("r"), py::arg("beta"),
           py::call_guard<py::gil_scoped_release>())
      .def("AddVecDivVec", &VectorBase<float>::AddVecDivVec,
           "Add element-by-element quotient of two vectors. this <---- "
           "alpha*v/r + beta*this",
           py::arg("alpha"), py::arg("v"), py::arg("r"), py::arg("beta"),
           py::call_guard<py::gil_scoped_release>())
      .def("Scale", &VectorBase<float>::Scale,
           "Multiplies all elements by this constant.", py::arg("alpha"),
           py::call_guard<py::gil_scoped_release>())
      /*.def("MulTp",
        &VectorBase<float>::MulTp,
        "Multiplies this vector by lower-triangular matrix:  *this <-- *this
      *M", py::arg("M"), py::arg("trans")) .def("Solve",
        &VectorBase<float>::Solve,
        "If trans == kNoTrans, solves M x = b, where b is the value of *this at
      input " "and x is the value of *this at output. " "If trans == kTrans,
      solves M' x = b. " "Does not test for M being singular or near-singular,
      so test it before " "calling this routine.", py::arg("M"),
        py::arg("trans"))*/
      .def("Max",
           (float(VectorBase<float>::*)() const) & VectorBase<float>::Max,
           "Returns the maximum value of any element, or -infinity for the "
           "empty vector.",
           py::call_guard<py::gil_scoped_release>())
      .def("Max",
           (float(VectorBase<float>::*)(MatrixIndexT *) const) &
               VectorBase<float>::Max,
           "Returns the maximum value of any element, and the associated "
           "index. Error if vector is empty.",
           py::arg("index"), py::call_guard<py::gil_scoped_release>())
      .def("Min",
           (float(VectorBase<float>::*)() const) & VectorBase<float>::Min,
           "Returns the minimum value of any element, or +infinity for the "
           "empty vector.",
           py::call_guard<py::gil_scoped_release>())
      .def("Min",
           (float(VectorBase<float>::*)(MatrixIndexT *) const) &
               VectorBase<float>::Min,
           "Returns the minimum value of any element, and the associated "
           "index. Error if vector is empty.",
           py::arg("index"), py::call_guard<py::gil_scoped_release>())
      .def("Sum", &VectorBase<float>::Sum, "Returns sum of the elements",
           py::call_guard<py::gil_scoped_release>())
      .def("SumLog", &VectorBase<float>::SumLog,
           "Returns sum of the logs of the elements.  More efficient than "
           "just taking log of each.  Will return NaN if any elements are "
           "negative.",
           py::call_guard<py::gil_scoped_release>())
      .def("AddRowSumMat", &VectorBase<float>::AddRowSumMat,
           "Does *this = alpha * (sum of rows of M) + beta * *this.",
           py::arg("alpha"), py::arg("M"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("AddColSumMat", &VectorBase<float>::AddColSumMat,
           "Does *this = alpha * (sum of columns of M) + beta * *this.",
           py::arg("alpha"), py::arg("M"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("AddDiagMat2", &VectorBase<float>::AddDiagMat2,
           ...
           py::arg("alpha"), py::arg("M"), py::arg("trans") = kNoTrans,
           py::arg("beta") = 1.0, py::call_guard<py::gil_scoped_release>())
      .def("AddDiagMatMat", &VectorBase<float>::AddDiagMatMat,
           "Add the diagonal of a matrix product: *this = diag(M N), assuming "
           "the "
           "\"trans\" arguments are both kNoTrans; for transpose arguments, it "
           "behaves "
           "as you would expect.",
           py::arg("alpha"), py::arg("M"), py::arg("trans"), py::arg("N"),
           py::arg("transN"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("LogSumExp", &VectorBase<float>::LogSumExp,
           ...
           py::arg("prune") = -1.0, py::call_guard<py::gil_scoped_release>())
      ...
      .def("Write", &VectorBase<float>::Write,
           ...
           py::arg("binary"), py::call_guard<py::gil_scoped_release>())
      .def("InvertElements", &VectorBase<float>::InvertElements,
           "Invert all elements.", py::call_guard<py::gil_scoped_release>())
  ...
  py::class_<Vector<float>, VectorBase<float>>(m, "FloatVector",
      ...
      .def("from_numpy",
           [](Vector<float> &v, py::array_t<float> x) {
             auto r = x.unchecked<1>();
             v.Resize(r.shape(0));
             for (py::size_t i = 0; i < r.shape(0); i++) v(i) = r(i);
           })
      .def(py::pickle(
  ...
  py::class_<VectorBase<double>,
      ...
      .def("Dim", &VectorBase<double>::Dim,
           "Returns the dimension of the vector.")
      .def("SetZero", &VectorBase<double>::SetZero, "Set vector to all zeros.",
           py::call_guard<py::gil_scoped_release>())
      ...
      .def("Ceiling", &VectorBase<double>::Ceiling,
           ...
           py::arg("v"), py::arg("ceil_val"), py::arg("ceiled_count") = nullptr,
           py::call_guard<py::gil_scoped_release>())
      .def("Pow", &VectorBase<double>::Pow, py::arg("v"), py::arg("power"),
           py::call_guard<py::gil_scoped_release>())
      ...
      .def("ApplyAbs", &VectorBase<double>::ApplyAbs,
           ...
           py::call_guard<py::gil_scoped_release>())
      .def("ApplyFloor",
           py::overload_cast<double, MatrixIndexT *>(
               &VectorBase<double>::ApplyFloor),
           "Applies floor to all elements. Returns number of elements "
           "floored in floored_count if it is non-null.",
           py::arg("floor_val"), py::arg("floored_count") = nullptr,
           py::call_guard<py::gil_scoped_release>())
      .def("ApplyCeiling", &VectorBase<double>::ApplyCeiling,
           ...
           py::call_guard<py::gil_scoped_release>())
      .def("ApplyFloor",
           py::overload_cast<const VectorBase<double> &>(
               &VectorBase<double>::ApplyFloor),
           "Applies floor to all elements. Returns number of elements floored.",
           py::arg("floor_vec"), py::call_guard<py::gil_scoped_release>())
      .def(
          "ApplySoftMax", &VectorBase<double>::ApplySoftMax,
          "Apply soft-max to vector and return normalizer (log sum of "
          "exponentials). "
          "This is the same as: \\f$ x(i) = exp(x(i)) / \\sum_i exp(x(i)) \\f$",
          py::call_guard<py::gil_scoped_release>())
      .def(
          "ApplyLogSoftMax", &VectorBase<double>::ApplyLogSoftMax,
          "Applies log soft-max to vector and returns normalizer (log sum of "
          "exponentials). "
          "This is the same as: \\f$ x(i) = x(i) - log(\\sum_i exp(x(i))) \\f$",
          py::call_guard<py::gil_scoped_release>())
      .def("Tanh", &VectorBase<double>::Tanh,
           "Sets each element of *this to the tanh of the corresponding "
           "element of \"src\".",
           py::arg("src"), py::call_guard<py::gil_scoped_release>())
      .def("Sigmoid", &VectorBase<double>::Sigmoid,
           "Sets each element of *this to the sigmoid function of the "
           "corresponding "
           "element of \"src\".",
           py::arg("src"), py::call_guard<py::gil_scoped_release>())
      .def("ApplyPow", &VectorBase<double>::ApplyPow,
           "Take all  elements of vector to a power.", py::arg("power"),
           py::call_guard<py::gil_scoped_release>())
      .def("ApplyPowAbs", &VectorBase<double>::ApplyPowAbs,
           "Take the absolute value of all elements of a vector to a power. "
           "Include the sign of the input element if include_sign == true. "
           "If power is negative and the input value is zero, the output is "
           "set zero.",
           py::arg("power"), py::arg("include_sign") = false,
           py::call_guard<py::gil_scoped_release>())
      .def("Norm", &VectorBase<double>::Norm,
           "Compute the p-th norm of the vector.", py::arg("p"),
           py::call_guard<py::gil_scoped_release>())
      .def("ApproxEqual", &VectorBase<double>::ApproxEqual,
           "Returns true if ((*this)-other).Norm(2.0) <= tol * "
           "(*this).Norm(2.0).",
           py::arg("other"), py::arg("tol") = 0.01)
      .def("AddVec",
           py::overload_cast<const double, const VectorBase<double> &>(
               &VectorBase<double>::AddVec<double>),
           "Add vector : *this = *this + alpha * rv (with casting between "
           "floats and doubles)",
           py::arg("alpha"), py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def(
          "CopyFromVec",
          [](VectorBase<double> &v, const VectorBase<double> &other) {
            v.CopyFromVec(other);
          },
          "Copy data from another vector (must match own size).",
          py::arg("other"), py::call_guard<py::gil_scoped_release>())
      /*.def("AddVec2",
        py::overload_cast<const double, const VectorBase<double>
        &>(&VectorBase<double>::AddVec2<double>), "Add vector : *this = *this +
        alpha * rv^2  [element-wise squaring].", py::arg("alpha"),
        py::arg("v"))*/
      .def("AddMatVec", &VectorBase<double>::AddMatVec,
           "Add matrix times vector : this <-- beta*this + alpha*M*v. Calls "
           "BLAS GEMV.",
           py::arg("alpha"), py::arg("M"), py::arg("trans"), py::arg("v"),
           py::arg("beta"), py::call_guard<py::gil_scoped_release>())
      .def("AddMatSvec", &VectorBase<double>::AddMatSvec,
           "This is as AddMatVec, except optimized for where v contains a lot "
           "of zeros.",
           py::arg("alpha"), py::arg("M"), py::arg("trans"), py::arg("v"),
           py::arg("beta"), py::call_guard<py::gil_scoped_release>())
      ...
      .def("AddTpVec",
        ...
        py::arg("v"),
        py::arg("beta"))*/
      .def("ReplaceValue", &VectorBase<double>::ReplaceValue,
           "Set each element to y = (x == orig ? changed : x).",
           py::arg("orig"), py::arg("changed"),
           py::call_guard<py::gil_scoped_release>())
      .def("MulElements",
           (void(VectorBase<double>::*)(const VectorBase<double> &)) &
               VectorBase<double>::MulElements,
           "Multiply element-by-element by another vector.", py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def("DivElements",
           (void(VectorBase<double>::*)(const VectorBase<double> &)) &
               VectorBase<double>::DivElements,
           "Divide element-by-element by another vector.", py::arg("v"),
           py::call_guard<py::gil_scoped_release>())
      .def("Add", &VectorBase<double>::Add,
           "Add a constant to each element of a vector.", py::arg("c"),
           py::call_guard<py::gil_scoped_release>())
      .def("AddVecVec", &VectorBase<double>::AddVecVec,
           "Add element-by-element product of vectors: this <-- alpha * v .* r "
           "+ beta*this .",
           py::arg("alpha"), py::arg("v"), py::arg("r"), py::arg("beta"),
           py::call_guard<py::gil_scoped_release>())
      .def("AddVecDivVec", &VectorBase<double>::AddVecDivVec,
           "Add element-by-element quotient of two vectors. this <---- "
           "alpha*v/r + beta*this",
           py::arg("alpha"), py::arg("v"), py::arg("r"), py::arg("beta"),
           py::call_guard<py::gil_scoped_release>())
      .def("Scale", &VectorBase<double>::Scale,
           "Multiplies all elements by this constant.", py::arg("alpha"),
           py::call_guard<py::gil_scoped_release>())
      /*.def("MulTp",
      ...
      *M", py::arg("M"), py::arg("trans")) .def("Solve",
      ...
      .def("Max",
           ...
           py::call_guard<py::gil_scoped_release>())
      .def("Max",
           (double(VectorBase<double>::*)(MatrixIndexT *) const) &
               VectorBase<double>::Max,
           "Returns the maximum value of any element, and the associated "
           "index. Error if vector is empty.",
           py::arg("index"), py::call_guard<py::gil_scoped_release>())
      .def("Min",
      ...
      .def("Min",
           (double(VectorBase<double>::*)(MatrixIndexT *) const) &
               VectorBase<double>::Min,
           "Returns the minimum value of any element, and the associated "
           "index. Error if vector is empty.",
           py::arg("index"), py::call_guard<py::gil_scoped_release>())
      .def("Sum", &VectorBase<double>::Sum, "Returns sum of the elements",
           py::call_guard<py::gil_scoped_release>())
      .def("SumLog", &VectorBase<double>::SumLog,
           "Returns sum of the logs of the elements.  More efficient than "
           "just taking log of each.  Will return NaN if any elements are "
           "negative.",
           py::call_guard<py::gil_scoped_release>())
      .def("AddRowSumMat", &VectorBase<double>::AddRowSumMat,
           "Does *this = alpha * (sum of rows of M) + beta * *this.",
           py::arg("alpha"), py::arg("M"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("AddColSumMat", &VectorBase<double>::AddColSumMat,
           "Does *this = alpha * (sum of columns of M) + beta * *this.",
           py::arg("alpha"), py::arg("M"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("AddDiagMat2", &VectorBase<double>::AddDiagMat2,
           "Add the diagonal of a matrix times itself: "
           "*this = diag(M M^T) +  beta * *this (if trans == kNoTrans), or "
           "*this = diag(M^T M) +  beta * *this (if trans == kTrans).",
           py::arg("alpha"), py::arg("M"), py::arg("trans") = kNoTrans,
           py::arg("beta") = 1.0, py::call_guard<py::gil_scoped_release>())
      .def("AddDiagMatMat", &VectorBase<double>::AddDiagMatMat,
           "Add the diagonal of a matrix product: *this = diag(M N), assuming "
           "the "
           "\"trans\" arguments are both kNoTrans; for transpose arguments, it "
           "behaves "
           ...
           py::arg("transN"), py::arg("beta") = 1.0,
           py::call_guard<py::gil_scoped_release>())
      .def("LogSumExp", &VectorBase<double>::LogSumExp,
           "Returns log(sum(exp())) without exp overflow "
           "If prune > 0.0, ignores terms less than the max - prune. "
           "[Note: in future, if prune = 0.0, it will take the max. "
           "For now, use -1 if you don't want it to prune.]",
           py::arg("prune") = -1.0, py::call_guard<py::gil_scoped_release>())
      .def("Read", &VectorBase<double>::Read,
           "Reads from C++ stream (option to add to existing contents). "
           "Throws exception on failure",
           py::arg("in"), py::arg("binary"), py::arg("add") = false,
           py::call_guard<py::gil_scoped_release>())
      .def("Write", &VectorBase<double>::Write,
           "Writes to C++ stream (option to write in binary).", py::arg("Out"),
           py::arg("binary"), py::call_guard<py::gil_scoped_release>())
      .def("InvertElements", &VectorBase<double>::InvertElements,
           "Invert all elements.", py::call_guard<py::gil_scoped_release>())
  ...
  py::class_<Vector<double>, VectorBase<double>>(m, "DoubleVector",
      ...
      .def("Resize", &Vector<double>::Resize,
           ...
           py::arg("length"), py::arg("resize_type") = kSetZero)
      .def("from_numpy",
           [](Vector<double> &v, py::array_t<double> x) {
             auto r = x.unchecked<1>();
             v.Resize(r.shape(0));
             for (py::size_t i = 0; i < r.shape(0); i++) v(i) = r(i);
           })
