...
void pybind_clusterable_itf(py::module &m) {
  ...
  py::class_<PyClass>(m, "Clusterable")
      .def("Copy", &PyClass::Copy, "Return a copy of this object.")
      ...
      .def("SetZero", &PyClass::SetZero, "Set stats to empty.")
      .def("Add", &PyClass::Add, "Add other stats.", py::arg("other"),
           py::call_guard<py::gil_scoped_release>())
      .def("Sub", &PyClass::Sub, "Subtract other stats", py::arg("other"))
      .def("Scale", &PyClass::Scale,
           "Scale the stats by a positive number f [not mandatory to supply "
           "this].",
           py::arg("f"))
      .def("Type", &PyClass::Type,
           "Return a string that describes the inherited type.")
      .def("Write", &PyClass::Write, "Write data to stream.", py::arg("os"),
           py::arg("binary"))
      ...
      .def("ObjfMinus", &PyClass::ObjfMinus,
           "Return the objective function of the subtracted object this - "
           "other.",
           py::arg("other"))
...
void pybind_transition_information_itf(py::module &m) {
  ...
  py::class_<PyClass>(m, "TransitionInformation")
      ...
      .def("TransitionIdIsStartOfPhone", &PyClass::TransitionIdIsStartOfPhone,
           "Returns true if this trans_id corresponds to the start of a phone.",
           py::arg("trans_id"))
