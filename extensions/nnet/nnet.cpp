...
class PyComponent : public Component {
 public:
  ...
  ComponentType GetType() const override {
    PYBIND11_OVERRIDE_PURE(ComponentType,  // Return type (ret_type)
                           Component,      // Parent class (cname)
                           GetType  // Name of function in C++ (must match
  ...
  std::string Info() const override {
    PYBIND11_OVERRIDE_PURE(std::string,  // Return type (ret_type)
                           Component,    // Parent class (cname)
                           Info  // Name of function in C++ (must match Python
                                 // name) (fn) Argument(s) (...)
    );
  }
  ...
  std::string InfoGradient() const override {
    PYBIND11_OVERRIDE_PURE(std::string,  // Return type (ret_type)
                           Component,    // Parent class (cname)
                           InfoGradient  // Name of function in C++ (must match
                                         // Python name) (fn) Argument(s) (...)
    );
  }
 ...
 protected:
  ...
  void BackpropagateFnc(const CuMatrixBase<BaseFloat> &in,
    ...
    PYBIND11_OVERRIDE_PURE(void,              // Return type (ret_type)
                           Component,         // Parent class (cname)
                           BackpropagateFnc,  // Name of function in C++ (must
...
class PyRbmBase : public RbmBase {
 public:
  ...
  void Reconstruct(const CuMatrixBase<BaseFloat> &hid_state,
                   CuMatrix<BaseFloat> *vis_probs) override {
    PYBIND11_OVERRIDE_PURE(
        void,         // Return type (ret_type)
  ...
  void RbmUpdate(const CuMatrixBase<BaseFloat> &pos_vis,
                 ...
                 const CuMatrixBase<BaseFloat> &neg_hid) override {
    PYBIND11_OVERRIDE_PURE(
        void,       // Return type (ret_type)
        RbmBase,    // Parent class (cname)
...
class PyLossItf : public LossItf {
 public:
  ...
  void Eval(const VectorBase<BaseFloat> &frame_weights,
            const CuMatrixBase<BaseFloat> &net_out, const Posterior &target,
            CuMatrix<BaseFloat> *diff) override {
    PYBIND11_OVERRIDE_PURE(
        void,     // Return type (ret_type)
        LossItf,  // Parent class (cname)
  ...
  std::string Report() override {
    PYBIND11_OVERRIDE_PURE(std::string,  // Return type (ret_type)
                           LossItf,      // Parent class (cname)
                           Report  // Name of function in C++ (must match Python
                                   // name) (fn) Argument(s) (...)
    );
  }
 ...
 public:
  ...
  int32 NumParams() const override {
    PYBIND11_OVERRIDE_PURE(int32,               // Return type (ret_type)
                           ...
                           NumParams  // Name of function in C++ (must match
                                      // Python name) (fn) Argument(s) (...)
    );
  }
...
void pybind_nnet_nnet_activation(py::module &m) {
  {
    ...
    auto softmax = py::class_<Softmax, Component>(m, "Softmax");
    softmax.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"));
  }
  {
    using PyClass = HiddenSoftmax;

    auto hidden_softmax =
        py::class_<HiddenSoftmax, Component>(m, "HiddenSoftmax");
    hidden_softmax
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
  ...
  }
  {
    ...
    auto block_softmax = py::class_<BlockSoftmax, Component>(m, "BlockSoftmax");
    block_softmax
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
        .def("ReadData", &PyClass::ReadData, py::arg("is"), py::arg("binary"))
        .def("WriteData", &PyClass::WriteData, py::arg("os"), py::arg("binary"))
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"))
  ...
  }
  {
    ...
    auto sigmoid = py::class_<Sigmoid, Component>(m, "Sigmoid");
    sigmoid.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
  ...
  }
  {
    ...
    auto tanh = py::class_<Tanh, Component>(m, "Tanh");
    tanh.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
  ...
  }
  {
    ...
    auto dropout = py::class_<Dropout, Component>(m, "Dropout");
    dropout.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
        .def("ReadData", &PyClass::ReadData, py::arg("is"), py::arg("binary"))
        ...
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"))
        .def("GetDropoutRate", &PyClass::GetDropoutRate)
        .def("SetDropoutRate", &PyClass::SetDropoutRate, py::arg("dr"));
  }
}
...
void pybind_nnet_nnet_affine_transform(py::module &m) {
  {
    ...
    auto affine_transform =
        py::class_<AffineTransform, UpdatableComponent>(m, "AffineTransform");
    affine_transform
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        ...
        .def("ReadData", &PyClass::ReadData, py::arg("is"), py::arg("binary"))
        .def("WriteData", &PyClass::WriteData, py::arg("os"), py::arg("binary"))
        .def("NumParams", &PyClass::NumParams, "Number of trainable parameters")
        .def("GetGradient", &PyClass::GetGradient,
             "Get gradient reshaped as a vector", py::arg("gradient"))
        .def("GetParams", &PyClass::GetParams,
             "Get the trainable parameters reshaped as a vector",
             py::arg("params"))
        .def("SetParams", &PyClass::SetParams,
             "Set the trainable parameters from, reshaped as a vector",
             py::arg("params"))
        .def("Info", &PyClass::Info,
             "Print some additional info (after <ComponentName> and the dims)")
        .def("InfoGradient", &PyClass::InfoGradient,
             "Print some additional info about gradient (after <...> and dims)")
        .def("Update", &PyClass::Update,
             "Compute gradient and update parameters", py::arg("input"),
             py::arg("diff"))
        .def("GetBias", &PyClass::GetBias)
        .def("SetBias", &PyClass::SetBias, py::arg("bias"))
        .def("GetLinearity", &PyClass::GetLinearity)
        .def("SetLinearity", &PyClass::SetLinearity, py::arg("linearity"));
  }
}
...
void pybind_nnet_nnet_average_pooling_component(py::module &m) {
  {
    ...
    auto average_pooling_component =
        py::class_<AveragePoolingComponent, Component>(
            m, "AveragePoolingComponent");
    average_pooling_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
...
void pybind_nnet_nnet_blstm_projected(py::module &m) {
  {
    ...
    auto blstm_projected =
        py::class_<BlstmProjected, MultistreamComponent>(m, "BlstmProjected");
    blstm_projected
        ...
        .def("InfoGradient", &PyClass::InfoGradient,
             "Print some additional info about gradient (after <...> and dims)")
        .def("ResetStreams", &PyClass::ResetStreams,
...
void pybind_nnet_nnet_component(py::module &m) {
  {
    ...
    auto component = py::class_<PyClass, PyComponent>(m, "Component");
    component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def_static("TypeToMarker", &PyClass::TypeToMarker,
                    "Converts component type to marker", py::arg("t"))
        .def_static("MarkerToType", &PyClass::MarkerToType,
                    "Converts marker to component type (case insensitive)",
                    py::arg("s"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType,
             "Get Type Identification of the component")
        .def("IsUpdatable", &PyClass::IsUpdatable,
             "Check if component has 'Updatable' interface (trainable "
             "components)")
        .def("IsMultistream", &PyClass::IsMultistream,
             "Check if component has 'Recurrent' interface (trainable and "
             "recurrent)")
        .def("InputDim", &PyClass::InputDim, "Get the dimension of the input")
        .def("OutputDim", &PyClass::OutputDim,
             "Get the dimension of the output")
        .def_static("Init", &PyClass::Init, py::arg("conf_line"))
        .def_static("Read", &PyClass::Read, py::arg("is"), py::arg("binary"))
        .def("Write", &PyClass::Write, py::arg("os"), py::arg("binary"))
        .def("Info", &PyClass::Info,
             "Print some additional info (after <ComponentName> and the dims)")
        .def(
            "InfoGradient", &PyClass::InfoGradient,
            "Print some additional info about gradient (after <...> and dims)");

    py::enum_<Component::ComponentType>(component, "ComponentType")
        .value("kUnknown", Component::ComponentType::kUnknown)
        .value("kUpdatableComponent",
               Component::ComponentType::kUpdatableComponent)
        ...
        .value("kConvolutionalComponent",
               Component::ComponentType::kConvolutionalComponent)
        .value("kLstmProjected", Component::ComponentType::kLstmProjected)
        .value("kBlstmProjected", Component::ComponentType::kBlstmProjected)
        .value("kRecurrentComponent",
               Component::ComponentType::kRecurrentComponent)
        .value("kActivationFunction",
               Component::ComponentType::kActivationFunction)
        ...
        .value("kLengthNormComponent",
               Component::ComponentType::kLengthNormComponent)
        ...
        .value("kSentenceAveragingComponent",
               Component::ComponentType::kSentenceAveragingComponent)
        .value("kSimpleSentenceAveragingComponent",
               Component::ComponentType::kSimpleSentenceAveragingComponent)
        .value("kAveragePoolingComponent",
               Component::ComponentType::kAveragePoolingComponent)
        .value("kMaxPoolingComponent",
               Component::ComponentType::kMaxPoolingComponent)
        .value("kFramePoolingComponent",
               Component::ComponentType::kFramePoolingComponent)
        .value("kParallelComponent",
               Component::ComponentType::kParallelComponent)
        .value("kMultiBasisComponent",
               Component::ComponentType::kMultiBasisComponent)
        .export_values();
  ...
  }
  {
    ...
    auto updatable_component =
        py::class_<UpdatableComponent, PyUpdatableComponent>(
    ...
    updatable_component
        ...
        .def("Update", &PyClass::Update,
             "Compute gradient and update parameters", py::arg("input"),
             py::arg("diff"))
        .def("SetTrainOptions", &PyClass::SetTrainOptions,
             "Set the training options to the component", py::arg("opts"))
        .def("GetTrainOptions", &PyClass::GetTrainOptions,
             "Get the training options from the component")
        .def("SetLearnRateCoef", &PyClass::SetLearnRateCoef,
             "Set the learn-rate coefficient", py::arg("val"))
        .def("SetBiasLearnRateCoef", &PyClass::SetBiasLearnRateCoef,
             "Set the learn-rate coefficient for bias", py::arg("val"))
        .def("InitData", &PyClass::InitData,
             "Initialize the content of the component by the 'line' from the "
             "prototype",
             py::arg("is"));
  }
  {
    ...
    auto multistream_component =
        py::class_<MultistreamComponent, PyMultistreamComponent>(
            m, "MultistreamComponent");
    multistream_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("IsMultistream", &PyClass::IsMultistream)
        .def("SetSeqLengths", &PyClass::SetSeqLengths,
             py::arg("sequence_lengths"))
        .def("NumStreams", &PyClass::NumStreams)
        .def("ResetStreams", &PyClass::ResetStreams);
  }
}
...
void pybind_nnet_nnet_convolutional_component(py::module &m) {
  {
    ...
    auto convolutional_component =
        py::class_<ConvolutionalComponent, UpdatableComponent>(
            m, "ConvolutionalComponent");
    convolutional_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
        ...
        .def("InfoGradient", &PyClass::InfoGradient,
             "Print some additional info about gradient (after <...> and dims)")
        .def(
            "ReverseIndexes", &PyClass::ReverseIndexes,
            ...
            py::arg("forward_indexes"), py::arg("backward_indexes"))
        .def(
            "RearrangeIndexes", &PyClass::RearrangeIndexes,
            "This function transforms a vector of lists into a list of "
            "vectors, "
            "padded with -1. "
            "@param[in] The input vector of lists. Let in.size() be D, and let "
            "            the longest list length (i.e. the max of "
            "in[i].size()) be L. "
            "@param[out] The output list of vectors. The length of the list "
            "will "
            "            be L, each vector-dimension will be D (i.e. "
            "out[i].size() == D), "
            "            and if in[i] == j, then for some k we will have that "
            "            out[k][j] = i. The output vectors are padded with -1 "
            "            where necessary if not all the input lists have the "
            "same side.",
...
void pybind_nnet_nnet_frame_pooling_component(py::module &m) {
  {
    ...
    auto frame_pooling_component =
        py::class_<FramePoolingComponent, UpdatableComponent>(
            m, "FramePoolingComponent");
    frame_pooling_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
...
void pybind_nnet_nnet_kl_hmm(py::module &m) {
  {
    ...
    auto kl_hmm_component = py::class_<KlHmm, Component>(m, "KlHmm");
    kl_hmm_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        ...
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"))
        .def("WriteData", &PyClass::WriteData, "Writes the component content",
             py::arg("os"), py::arg("binary"))
        .def("SetStats", &PyClass::SetStats, "Set the statistics matrix",
             py::arg("mat"))
        .def("Accumulate", &PyClass::Accumulate,
             "Accumulate the statistics for KL-HMM paramter estimation",
             py::arg("posteriors"), py::arg("alignment"));
  }
}
...
void pybind_nnet_nnet_linear_transform(py::module &m) {
  {
    ...
    auto linear_transform =
        py::class_<LinearTransform, UpdatableComponent>(m, "LinearTransform");
    linear_transform
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        ...
        .def("SetLinearity",
             ...
             py::arg("l"))
        .def("SetLinearity",
             py::overload_cast<const CuMatrixBase<BaseFloat> &>(
                 &PyClass::SetLinearity),
             py::arg("linearity"))
        .def("Info", &PyClass::Info,
             "Print some additional info (after <ComponentName> and the dims)")
        ...
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"))
        .def("GetLinearity", &PyClass::GetLinearity)
        .def("GetLinearityCorr", &PyClass::GetLinearityCorr)
        .def("Update", &PyClass::Update,
             "Compute gradient and update parameters", py::arg("input"),
             py::arg("diff"));
  }
...
void pybind_nnet_nnet_loss(py::module &m) {
  {
    ...
    auto loss_options = py::class_<PyClass>(m, "LossOptions");
  ...
  }
  {
    ...
    auto loss_itf = py::class_<PyClass, PyLossItf>(m, "LossItf");
    loss_itf.def(py::init<LossOptions &>(), py::arg("opts"))
        .def(
            "Eval",
            py::overload_cast<
                const VectorBase<BaseFloat> &, const CuMatrixBase<BaseFloat> &,
                const CuMatrixBase<BaseFloat> &, CuMatrix<BaseFloat> *>(
                &PyClass::Eval),
            "Evaluate cross entropy using target-matrix (supports soft labels)",
            py::arg("frame_weights"), py::arg("net_out"), py::arg("target"),
            py::arg("diff"))
        .def(
            "Eval",
            py::overload_cast<const VectorBase<BaseFloat> &,
                              const CuMatrixBase<BaseFloat> &,
                              const Posterior &, CuMatrix<BaseFloat> *>(
                &PyClass::Eval),
            "Evaluate cross entropy using target-matrix (supports soft labels)",
            py::arg("frame_weights"), py::arg("net_out"), py::arg("target"),
            py::arg("diff"))
        .def("Report", &PyClass::Report, "Generate string with error report")
        .def("AvgLoss", &PyClass::AvgLoss, "Get loss value (frame average)");
  }
  {
    using PyClass = Xent;

    auto xent = py::class_<Xent, LossItf>(m, "Xent");
    xent.def(py::init<LossOptions &>(), py::arg("opts"))
        .def(
            "Eval",
            py::overload_cast<
                const VectorBase<BaseFloat> &, const CuMatrixBase<BaseFloat> &,
        ...
        .def(
            ...
            py::arg("diff"))
        .def("Report", &PyClass::Report, "Generate string with error report")
        .def("ReportPerClass", &PyClass::ReportPerClass,
  ...
  }
  {
    ...
    auto mse = py::class_<Mse, LossItf>(m, "Mse");
    mse.def(py::init<LossOptions &>(), py::arg("opts"))
        .def(
            "Eval",
            py::overload_cast<
                const VectorBase<BaseFloat> &, const CuMatrixBase<BaseFloat> &,
  ...
  }
  {
    ...
    auto multi_task_loss =
        py::class_<MultiTaskLoss, LossItf>(m, "MultiTaskLoss");
    multi_task_loss.def(py::init<LossOptions &>(), py::arg("opts"))
        .def(
            "Eval",
            py::overload_cast<
                const VectorBase<BaseFloat> &, const CuMatrixBase<BaseFloat> &,
        ...
        .def("AvgLoss", &PyClass::AvgLoss, "Get loss value (frame average)")
        .def(
            "InitFromString", &PyClass::InitFromString,
...
void pybind_nnet_nnet_lstm_projected(py::module &m) {
  {
    ...
    auto lstm_projected =
        py::class_<LstmProjected, MultistreamComponent>(m, "LstmProjected");
    lstm_projected
        .def(py::init<int32, int32>(), py::arg("input_dim"),
             py::arg("output_dim"))
        .def("Copy", &PyClass::Copy)
...
void pybind_nnet_nnet_matrix_buffer(py::module &m) {
  {
    ...
    auto matrix_buffer_options = py::class_<PyClass>(m, "MatrixBufferOptions");
  ...
  }
  {
    ...
    auto matrix_buffer = py::class_<PyClass>(m, "MatrixBuffer");
    matrix_buffer.def(py::init<>())
        .def("Init", &PyClass::Init, py::arg("reader"),
             py::arg("opts") = MatrixBufferOptions())
        .def("Done", &PyClass::Done)
        .def("Next", &PyClass::Next)
        .def("ResetLength", &PyClass::ResetLength)
        .def("Key", &PyClass::Key)
        .def("Value", &PyClass::Value)
        .def("SizeInBytes", &PyClass::SizeInBytes)
        .def("SizeInMegaBytes", &PyClass::SizeInMegaBytes)
        .def("NumPairs", &PyClass::NumPairs);
  }
}
...
void pybind_nnet_nnet_max_pooling_component(py::module &m) {
  {
    ...
    auto max_pooling_component =
        py::class_<MaxPoolingComponent, Component>(m, "MaxPoolingComponent");
    max_pooling_component
        .def(py::init<int32, int32>(), py::arg("input_dim"),
             py::arg("output_dim"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
...
void pybind_nnet_nnet_multibasis_component(py::module &m) {
  ...
  auto multi_basis_component = py::class_<MultiBasisComponent,
  UpdatableComponent>( m, "MultiBasisComponent");
...
void pybind_nnet_nnet_nnet(py::module &m) {
  {
    ...
    auto nnet = py::class_<PyClass>(m, "Nnet");
    nnet.def(py::init<>())
        .def(py::init<const Nnet &>(), py::arg("other"))
        .def("Propagate", &PyClass::Propagate,
             "Perform forward pass through the network", py::arg("in"),
             py::arg("out"))
        .def("Backpropagate", &PyClass::Backpropagate,
             "Perform backward pass through the network", py::arg("out_diff"),
             py::arg("in_diff"))
        .def("Feedforward", &PyClass::Feedforward,
             "Perform forward pass through the network (with 2 swapping "
             "buffers)",
             py::arg("in"), py::arg("out"))
        .def("InputDim", &PyClass::InputDim,
             "Dimensionality on network input (input feature dim.)")
        .def("OutputDim", &PyClass::OutputDim,
             "Dimensionality of network outputs (posteriors | bn-features | "
             "etc.)")
        ...
        .def("ReplaceComponent", &PyClass::ReplaceComponent, py::arg("c"),
             py::arg("comp"))
        //.def("SwapComponent",
        //  static_cast< void (PyClass::*)(int32,
        //  Component**)>(&PyClass::SwapComponent), py::arg("c"),
        //  py::arg("comp"))
        .def("AppendComponent", &PyClass::AppendComponent, py::arg("comp"))
        .def("AppendComponentPointer", &PyClass::AppendComponentPointer,
             py::arg("dynamically_allocated_comp"))
        .def("AppendNnet", &PyClass::AppendNnet, py::arg("nnet_to_append"))
        .def("RemoveComponent", &PyClass::RemoveComponent, py::arg("c"))
        .def("RemoveLastComponent", &PyClass::RemoveLastComponent)
        .def("PropagateBuffer", &PyClass::PropagateBuffer)
        .def("BackpropagateBuffer", &PyClass::BackpropagateBuffer)
        .def("NumParams", &PyClass::NumParams)
        .def("GetGradient", &PyClass::GetGradient, py::arg("gradient"))
        .def("GetParams", &PyClass::GetParams, py::arg("params"))
        .def("SetParams", &PyClass::SetParams, py::arg("params"))
        .def("SetDropoutRate", &PyClass::SetDropoutRate, py::arg("r"))
        .def("ResetStreams", &PyClass::ResetStreams,
             py::arg("stream_reset_flag"))
        .def("SetSeqLengths", &PyClass::SetSeqLengths,
             py::arg("sequence_lengths"))
        .def("Init", &PyClass::Init, py::arg("proto_file"))
        .def("Read", py::overload_cast<const std::string &>(&PyClass::Read),
             py::arg("rxfilename"))
        .def("Read", py::overload_cast<std::istream &, bool>(&PyClass::Read),
             py::arg("in"), py::arg("binary"))
        .def("Write",
             static_cast<void (PyClass::*)(const std::string &, bool) const>(
                 &PyClass::Write),
             py::arg("wxfilename"), py::arg("binary"))
        .def("Write",
             static_cast<void (PyClass::*)(std::ostream &, bool) const>(
                 &PyClass::Write),
             py::arg("out"), py::arg("binary"))
        .def("Info", &PyClass::Info)
        .def("InfoGradient", &PyClass::InfoGradient, py::arg("header") = true)
        .def("InfoPropagate", &PyClass::InfoPropagate, py::arg("header") = true)
        .def("InfoBackPropagate", &PyClass::InfoBackPropagate,
             py::arg("header") = true)
        .def("Check", &PyClass::Check)
        .def("Destroy", &PyClass::Destroy)
        .def("SetTrainOptions", &PyClass::SetTrainOptions, py::arg("opts"))
        .def("GetTrainOptions", &PyClass::GetTrainOptions);
  }
}
...
void pybind_nnet_nnet_parallel_component(py::module &m) {
  {
    ...
    auto parallel_component =
        py::class_<ParallelComponent, MultistreamComponent>(
            m, "ParallelComponent");
    parallel_component
        .def(py::init<int32, int32>(), py::arg("input_dim"),
             py::arg("output_dim"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("GetNestedNnet", py::overload_cast<int32>(&PyClass::GetNestedNnet),
             py::arg("id"))
        .def("InitData", &PyClass::InitData, py::arg("is"))
        .def("ReadData", &PyClass::ReadData, py::arg("is"), py::arg("binary"))
        .def("WriteData", &PyClass::WriteData, py::arg("os"), py::arg("binary"))
        ...
        .def("Info", &PyClass::Info)
        .def("InfoGradient", &PyClass::InfoGradient)
        .def("InfoPropagate", &PyClass::InfoPropagate)
        .def("InfoBackPropagate", &PyClass::InfoBackPropagate)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
        .def("BackpropagateFnc", &PyClass::BackpropagateFnc, py::arg("in"),
             py::arg("out"), py::arg("out_diff"), py::arg("in_diff"))
        .def("SetTrainOptions", &PyClass::SetTrainOptions, py::arg("opts"))
        .def("SetLearnRateCoef", &PyClass::SetLearnRateCoef, py::arg("val"))
        .def("SetBiasLearnRateCoef", &PyClass::SetBiasLearnRateCoef,
             py::arg("val"))
        .def("SetSeqLengths", &PyClass::SetSeqLengths,
             py::arg("sequence_lengths"));
...
void pybind_nnet_nnet_parametric_relu(py::module &m) {
  {
    ...
    auto parametric_relu =
        py::class_<ParametricRelu, UpdatableComponent>(m, "ParametricRelu");
    parametric_relu
        .def(py::init<int32, int32>(), py::arg("input_dim"),
             py::arg("output_dim"))
        .def("Copy", &PyClass::Copy)
...
void pybind_nnet_nnet_pdf_prior(py::module &m) {
  {
    ...
    auto pdf_prior_options = py::class_<PyClass>(m, "PdfPriorOptions");
  ...
  }
  {
    ...
    auto pdf_prior = py::class_<PyClass>(m, "PdfPrior");
    pdf_prior.def(py::init<const PdfPriorOptions &>(), py::arg("opts"))
        .def("SubtractOnLogpost", &PyClass::SubtractOnLogpost,
             "Subtract pdf priors from log-posteriors to get pseudo "
             "log-likelihoods",
             py::arg("llk"));
  }
}
...
void pybind_nnet_nnet_randomizer(py::module &m) {
  {
    ...
    auto nnet_data_randomizer_options =
        py::class_<PyClass>(m, "NnetDataRandomizerOptions");
  ...
  }
  {
    ...
    auto randomizer_mask = py::class_<PyClass>(m, "RandomizerMask");
    randomizer_mask
        .def(py::init<const NnetDataRandomizerOptions &>(), py::arg("conf"))
        .def("Init", &PyClass::Init, py::arg("conf"))
        .def("Generate", &PyClass::Generate, py::arg("mask_size"));
  }
  {
    using PyClass = MatrixRandomizer;

    auto matrix_randomizer = py::class_<PyClass>(m, "MatrixRandomizer");
    matrix_randomizer.def(py::init<>())
        .def(py::init<const NnetDataRandomizerOptions &>(), py::arg("conf"))
        .def("Init", &PyClass::Init, py::arg("conf"))
        .def("AddData", &PyClass::AddData, py::arg("m"))
        .def("IsFull", &PyClass::IsFull)
        .def("NumFrames", &PyClass::NumFrames)
        .def("Randomize", &PyClass::Randomize, py::arg("mask"))
        .def("Done", &PyClass::Done)
        .def("Next", &PyClass::Next)
        .def("Value", &PyClass::Value);
  }
  {
    ...
    auto vector_randomizer = py::class_<PyClass>(m, "VectorRandomizer");
  ...
  }
  {
    ...
    auto int32_vector_randomizer =
        py::class_<PyClass>(m, "Int32VectorRandomizer");
  ...
  }
  {
    ...
    auto posterior_randomizer = py::class_<PyClass>(m, "PosteriorRandomizer");
...
void pybind_nnet_nnet_rbm(py::module &m) {
  {
    ...
    auto rbm_base = py::class_<RbmBase, PyRbmBase>(m, "RbmBase");
    rbm_base
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Reconstruct", &PyClass::Reconstruct, py::arg("hid_state"),
             py::arg("vis_probs"))
        .def("RbmUpdate", &PyClass::RbmUpdate, py::arg("pos_vis"),
             py::arg("pos_hid"), py::arg("neg_vis"), py::arg("neg_hid"))
        .def("VisType", &PyClass::VisType)
        .def("HidType", &PyClass::HidType)
        .def("WriteAsNnet", &PyClass::WriteAsNnet, py::arg("os"),
             py::arg("binary"))
        .def("SetRbmTrainOptions", &PyClass::SetRbmTrainOptions,
             py::arg("opts"))
        .def("GetRbmTrainOptions", &PyClass::GetRbmTrainOptions);
  ...
  }
  {
    ...
    auto rbm = py::class_<Rbm, RbmBase>(m, "Rbm");
    rbm.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("InitData", &PyClass::InitData, py::arg("is"))
        .def("ReadData", &PyClass::ReadData, py::arg("is"), py::arg("binary"))
...
void pybind_nnet_nnet_recurrent(py::module &m) {
  {
    ...
    auto recurrent_component =
        py::class_<RecurrentComponent, MultistreamComponent>(
...
void pybind_nnet_nnet_sentence_averaging_component(py::module &m) {
  {
    ...
    auto simple_sentence_averaging_component =
        py::class_<SimpleSentenceAveragingComponent, Component>(
            m, "SimpleSentenceAveragingComponent");
    simple_sentence_averaging_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
...
void pybind_nnet_nnet_trnopts(py::module &m) {
  {
    ...
    auto nnet_train_options = py::class_<PyClass>(m, "NnetTrainOptions");
  ...
  }
  {
    ...
    auto rbm_train_options = py::class_<PyClass>(m, "RbmTrainOptions");
...
void pybind_nnet_nnet_various(py::module &m) {
  {
    ...
    auto splice = py::class_<Splice, Component>(m, "Splice");
    splice.def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
             py::arg("out"))
  ...
  }
  {
    ...
    auto copy_component =
        py::class_<CopyComponent, Component>(m, "CopyComponent");
    copy_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
  ...
  }
  {
    ...
    auto length_norm_component =
        py::class_<LengthNormComponent, Component>(m, "LengthNormComponent");
    length_norm_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        .def("PropagateFnc", &PyClass::PropagateFnc, py::arg("in"),
...

  {
    ...
    auto add_shift_component =
        py::class_<AddShift, UpdatableComponent>(m, "AddShift");
    add_shift_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
        ...
        .def("Update", &PyClass::Update,
             "Compute gradient and update parameters", py::arg("input"),
             py::arg("diff"))
        .def("SetLearnRateCoef", &PyClass::SetLearnRateCoef, py::arg("c"));
  }
  {
    using PyClass = Rescale;

    auto rescale_component =
        py::class_<Rescale, UpdatableComponent>(m, "Rescale");
    rescale_component
        .def(py::init<int32, int32>(), py::arg("dim_in"), py::arg("dim_out"))
        .def("Copy", &PyClass::Copy)
        .def("GetType", &PyClass::GetType)
